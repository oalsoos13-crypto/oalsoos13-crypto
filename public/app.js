...
const T = {
  ...
  letterKind: { ar: "نوع الكتاب", en: "Letter type" },
  ...
  r_contracts_d: { ar: "عقود الأنشطة التسويقية: فترة، مساحات وأدوات، قيمة، وملاحق.", en: "Marketing-activity contracts: period, spaces, value, and addenda." },
  cxNew: { ar: "＋ عقد جديد", en: "+ New contract" },
  cxManageSpaces: { ar: "أنواع الأدوات", en: "Fixture types" },
  cxAddendum: { ar: "＋ ملحق", en: "+ Addendum" },
  cxBase: { ar: "عقد", en: "Contract" },
  cxIsAddendum: { ar: "ملحق", en: "Addendum" },
  cxCode: { ar: "رقم/مرجع العقد", en: "Contract ref." },
  cxTitle: { ar: "عنوان العقد", en: "Title" },
  cxSubjectYear: { ar: "سنة النشاط التسويقي", en: "Marketing year" },
  cxIsRenewal: { ar: "تجديد عقد", en: "Renewal" },
  cxPartyRep: { ar: "ممثل الطرف الأول", en: "Party-1 rep" },
  cxContractDate: { ar: "تاريخ العقد", en: "Contract date" },
  ...
  cxRenewable: { ar: "قابل للتجديد", en: "Renewable" },
  cxValue: { ar: "قيمة العقد (د.ك)", en: "Contract value (KD)" },
  cxValueKind: { ar: "نوع القيمة", en: "Value kind" },
  ...
  cxItems: { ar: "المساحات والأدوات", en: "Spaces & fixtures" },
  cxScope: { ar: "النطاق", en: "Scope" },
  cxsc_main: { ar: "السوق المركزي", en: "Main market" },
  cxsc_branches: { ar: "جميع الفروع", en: "All branches" },
  cxsc_outlet: { ar: "منفذ محدد", en: "Specific outlet" },
  cxsc_all: { ar: "الكل", en: "All" },
  cxSpace: { ar: "الأداة", en: "Fixture" },
  cxCount: { ar: "العدد", en: "Count" },
  cxDimensions: { ar: "الأبعاد", en: "Dimensions" },
  cxCategory: { ar: "الصنف", en: "Category" },
  cxLocation: { ar: "الموقع/الرف", en: "Location" },
  cxAddItem: { ar: "＋ أداة", en: "+ Fixture" },
  cxInstallments: { ar: "الدفعات (تسليم الدفعات)", en: "Installments" },
  cxAutoSplit: { ar: "تقسيم قيمة العقد", en: "Split value" },
  cxSplitCount: { ar: "عدد الدفعات", en: "Count" },
  cxDue: { ar: "تاريخ الاستحقاق", en: "Due date" },
  cxSeq: { ar: "#", en: "#" },
  cxAmount: { ar: "المبلغ", en: "Amount" },
  cxAddInst: { ar: "＋ دفعة", en: "+ Installment" },
  cxPaid: { ar: "مدفوعة", en: "Paid" },
  cxPending: { ar: "مستحقة", en: "Pending" },
  cxTotal: { ar: "قيمة العقد", en: "Value" },
  cxNoContracts: { ar: "لا توجد عقود بعد.", en: "No contracts yet." },
  cxSpacesTitle: { ar: "أنواع الأدوات/المساحات", en: "Fixture / space types" },
  cxSpaceName: { ar: "اسم الأداة", en: "Fixture name" },
  cxSpaceImportHint: { ar: "ملف Excel: العمود الأول اسم الأداة (اختياري: عمود ثانٍ بالإنجليزية).", en: "Excel: first column Arabic fixture name (optional 2nd column English)." },
  cxRemove: { ar: "حذف", en: "Remove" },
  cxOutletOpt: { ar: "المنفذ", en: "Outlet" },
  cxAddSpace: { ar: "＋ أداة", en: "+ Fixture" },
  cxGenDN: { ar: "توليد إشعار خصم", en: "Generate debit note" },
  cxGenDNTitle: { ar: "توليد إشعار خصم من العقد", en: "Generate debit note from contract" },
  cxBilledFor: { ar: "المبلغ عن الفترة", en: "Amount for period" },
  ...
  meth_refs: { ar: "المراجع المعتمدة", en: "Approved references" },
  meth_ref: { ar: "المرجع", en: "Reference" },
  meth_by: { ar: "الجهة", en: "Body" },
  meth_yr: { ar: "السنة", en: "Year" },
  meth_visionGoals: { ar: "الرؤية والأهداف", en: "Vision & Goals" },
  meth_vision: { ar: "الرؤية", en: "Vision" },
  meth_goals: { ar: "الأهداف", en: "Goals" },
  meth_goalsHint: { ar: "هدف بكل سطر", en: "One goal per line" },
  meth_phases: { ar: "مراحل دورة الحياة — الحالة والتواريخ والخطوات الفرعية", en: "Lifecycle phases — status, dates & sub-steps" },
  meth_sops: { ar: "إجراءات التشغيل المعيارية (SOP)", en: "Standard Operating Procedures (SOP)" },
  meth_gaps: { ar: "نواقص مقابل المعيار العالمي", en: "Gaps vs. the global standard" },
  meth_gapsHint: { ar: "بنود موجودة بالأنظمة العالمية (PMI/ISO) ويُنصح بإضافتها لاكتمال الصورة:", en: "Items present in the global standards (PMI/ISO) worth adding for completeness:" },
  meth_save: { ar: "حفظ التعديلات", en: "Save changes" },
  meth_saveHint: { ar: "عدّل ثم احفظ — بينحفظ تاريخ التعديل تلقائياً.", en: "Edit then save — the edit date is stamped automatically." },
  meth_export: { ar: "تصدير PDF", en: "Export PDF" },
  meth_subs: { ar: "الخطوات الفرعية", en: "Sub-steps" },
  meth_subsHint: { ar: "خطوة فرعية بكل سطر", en: "One sub-step per line" },
  meth_stepsHint: { ar: "خطوة بكل سطر", en: "One step per line" },
  meth_phase: { ar: "المرحلة", en: "Phase" },
  meth_group: { ar: "مجموعة PMI", en: "PMI Group" },
  meth_status: { ar: "الحالة", en: "Status" },
  meth_start: { ar: "البداية", en: "Start" },
  meth_end: { ar: "النهاية", en: "End" },
  meth_note: { ar: "ملاحظة", en: "Note" },
  meth_role: { ar: "الدور", en: "Role" },
  meth_lastEdit: { ar: "آخر تعديل", en: "Last edited" },
  meth_editBy: { ar: "بواسطة", en: "by" },
  meth_notEdited: { ar: "القيم الأولية (لم تُعدّل بعد)", en: "Initial values (not edited yet)" },
  meth_done: { ar: "خلصت ✔", en: "Done ✔" },
  meth_ongoing: { ar: "ماشية ⟳", en: "Ongoing ⟳" },
  meth_partial: { ar: "جزئي ◐", en: "Partial ◐" },
  meth_notstarted: { ar: "ما بلّشت ☐", en: "Not started ☐" },
  meth_na: { ar: "لا ينطبق N-A", en: "N-A" },
  meth_completed: { ar: "مرحلة مكتملة", en: "phases completed" },
  meth_intro: { ar: "هذا النظام مبني ومُدار وفق دليل PMBOK® Guide — الإصدار السادس (PMI، 2017): مجموعات العمليات الخمس (البدء ← التخطيط ← التنفيذ ← المراقبة والضبط ← الإغلاق). البداية كانت من المرحلة (1) بالترتيب الصحيح.", en: "This system is built and managed per the PMBOK® Guide — 6th Edition (PMI, 2017): the five process groups (Initiating → Planning → Executing → Monitoring & Controlling → Closing). It started at phase (1) in the correct order." },
...
function pdfCur() {
  ...
  letterWindow(curDoc.rec, curDoc.isLetter, false);
}
// Open a clean print window for a letter/note (NATIVE print → correct Arabic).
// `record` also writes the official print for an admin-approved letter.
function letterWindow(rec, isLetter, record) {
  if (!rec) return;
  if (record && isLetter && currentUser.role === "admin" && rec.apprStage === "print" && !rec.printedAt) {
    api("/letters/" + rec.id + "/print", { method: "POST" })
      .then(() => { rec.printedAt = new Date().toISOString(); loadState(); })
      .catch(() => {});
  }
  const name = docFileName(rec, isLetter);
  const dir = document.documentElement.dir || "rtl";
  const w = window.open("", "_blank");
  if (!w) { toast(t("pdfErr")); return; }
...
// Row-level quick actions for a letter (no need to open the viewer first).
function quickPdf(id) { const L = (DB.letters || []).find((x) => x.id === id); if (L) letterWindow(L, true, false); }
function quickPrint(id) { const L = (DB.letters || []).find((x) => x.id === id); if (L) letterWindow(L, true, true); }
...
function renderMethodology() {
  ...
  const saveBar = isAdmin
    ? `<div class="actions" style="margin-top:12px"><button class="btn primary" onclick="saveMethodology()">💾 ${t("meth_save")}</button><span class="hint" style="margin-inline-start:10px">${t("meth_saveHint")}</span></div>`
    : "";
  document.getElementById("rv").innerHTML = `
  <div class="panel"><header><h3>📐 ${t("meth_title")}</h3><div style="display:flex;gap:8px;align-items:center"><span class="pill-info">v${esc(M.version)} · ${editedLine}</span>${topBtns}</div></header>
    <div class="body"><p class="hint">${t("meth_intro")} — <b>${done}/${total} ${t("meth_completed")}</b>.</p></div>
  </div>
  ${visionPanel}
  <div class="panel"><header><h3>${t("meth_refs")}</h3></header><div class="tbl-wrap"><table><thead><tr><th>${t("meth_ref")}</th><th>${t("meth_by")}</th><th>${t("meth_yr")}</th></tr></thead><tbody>${refRows}</tbody></table></div></div>
  <div class="panel"><header><h3>${t("meth_phases")}</h3></header><div class="tbl-wrap"><table><thead><tr><th>#</th><th>${t("meth_phase")}</th><th>${t("meth_group")}</th><th>${t("meth_status")}</th><th>${t("meth_start")}</th><th>${t("meth_end")}</th><th>${t("meth_note")}</th></tr></thead><tbody>${phaseTable}</tbody></table></div>${saveBar ? `<div class="body">${saveBar}</div>` : ""}</div>
...
// Export the methodology as a clean printable page (browser "Save as PDF").
function exportMethodology() {
  if (document.getElementById("methVision")) methCollect();
  const M = methData;
  const done = M.phases.filter((p) => p.st === "done").length;
  const total = M.phases.filter((p) => p.st !== "na").length;
  const rtl = LANG !== "en";
  ...
  table{border-collapse:collapse;width:100%;font-size:12px;margin:6px 0}th,td{border:1px solid #ccc;padding:5px 7px;text-align:${rtl ? "right" : "left"}}th{background:#1F4E79;color:#fff}
  .sop{margin:8px 0;padding:6px 10px;border:1px solid #ddd;border-radius:6px}ol{margin:4px 0;padding-inline-start:20px}
...
/* ---------- per-coop + letter-type calc settings ---------- */
let ctData = { coops: [], rows: [] };
async function vCoopTerms() {
  const types = (DB.ref.letterTypes || []).map((x) => ({ k: x.k, label: typeLabel(x) }));
  document.getElementById("rv").innerHTML = `
  <div class="panel"><header><h3>${t("r_coopTerms")}</h3></header>
    <div class="hint" style="padding:6px 16px">${t("coopTermsHint")}</div>
    <div class="grid g3" style="padding:0 16px 6px">
      <div class="field"><label>${t("coop")}</label><select id="ctCoop"></select></div>
      <div class="field"><label>${t("letterKind")}</label><select id="ctLt">${types.map((x) => `<option value="${esc(x.k)}">${esc(x.label)}</option>`).join("")}</select></div>
      <div class="field"><label>${t("calcType")}</label><select id="ctType" onchange="ctFormToggle()"><option value="bonus">${t("type_bonus")}</option><option value="amount">${t("type_amount")}</option><option value="amount_pct">${t("type_amount_pct")}</option></select></div>
    </div>
    <div class="grid g3" style="padding:0 16px 6px">
      <div class="field" id="ctUnitW"><label>${t("unitCol")}</label><select id="ctUnit"><option value="carton">${t("byCarton")}</option><option value="piece">${t("byPiece")}</option></select></div>
      <div class="field" id="ctMultW"><label>${t("multiplierCol")}</label><input id="ctMult" type="number" step="0.001" value="2"></div>
      <div class="field" id="ctAmtW"><label>${t("amountCol")}</label><input id="ctAmt" type="number" step="0.001" value="0"></div>
      <div class="field" id="ctPctW"><label>${t("pctCol")}</label><input id="ctPct" type="number" step="0.01" value="0"></div>
    </div>
    <div class="actions" style="padding:0 16px 12px"><button class="btn primary sm" onclick="saveCoopTerm()">＋ ${t("saveRow")}</button></div>
    <div class="tbl-wrap" id="ctBox"><div class="empty">${t("loading")}</div></div></div>`;
  ctData = await api("/coop-terms");
  const cs = document.getElementById("ctCoop"); if (cs) cs.innerHTML = ctData.coops.map((c) => `<option value="${esc(c)}">${esc(c)}</option>`).join("");
  ctFormToggle(); renderCoopTermsList();
}
function ctFormToggle() {
  const ty = (document.getElementById("ctType") || {}).value;
  const show = (id, on) => { const e = document.getElementById(id); if (e) e.style.display = on ? "" : "none"; };
  show("ctUnitW", ty === "bonus"); show("ctMultW", ty === "bonus");
  show("ctAmtW", ty === "amount" || ty === "amount_pct"); show("ctPctW", ty === "amount_pct");
}
function renderCoopTermsList() {
  const box = document.getElementById("ctBox"); if (!box) return;
  const summ = (r) => r.calc_type === "bonus" ? `1+1 · ${r.unit === "piece" ? t("byPiece") : t("byCarton")} · ×${r.multiplier}`
    : r.calc_type === "amount" ? `${t("type_amount")}: ${KD(r.amount)}`
      : `${t("type_amount_pct")}: ${KD(r.amount)} + ${r.pct}%`;
  box.innerHTML = ctData.rows.length
    ? `<table><thead><tr><th>${t("coop")}</th><th>${t("letterKind")}</th><th>${t("calcType")}</th><th></th></tr></thead><tbody>${ctData.rows.map((r) => `<tr><td>${esc(r.coop)}</td><td>${esc(ltName(r.letter_type))}</td><td>${esc(summ(r))}</td><td><button class="btn danger sm" onclick="delCoopTerm('${esc(r.coop).replace(/'/g, "\\'")}','${esc(r.letter_type)}')">${t("del")}</button></td></tr>`).join("")}</tbody></table>`
    : `<div class="empty">—</div>`;
}
async function saveCoopTerm() {
  const g = (id) => document.getElementById(id).value;
  const body = { coop: g("ctCoop"), letter_type: g("ctLt"), calc_type: g("ctType"), unit: g("ctUnit"), multiplier: g("ctMult"), amount: g("ctAmt"), pct: g("ctPct") };
  if (!body.coop) { toast(t("choose") + " " + t("coop")); return; }
  try { await api("/coop-terms", { method: "POST", body }); toast(t("savedCell")); ctData = await api("/coop-terms"); renderCoopTermsList(); } catch (e) { toast(e.message); }
}
...
function cxScopeLabel(it) {
  ...
  return t("cxsc_" + (it.scope || "main"));
}
function cxEditCoop() { return cxEdit ? cxEdit.coop : ""; }
...
function cxEditContract(id, parentId) {
  if (id) {
    cxEdit = JSON.parse(JSON.stringify(cxData.contracts.find((x) => x.id === id)));
  } else if (parentId) {
    const p = cxData.contracts.find((x) => x.id === parentId);
    cxEdit = { id: 0, kind: "addendum", parentId, code: "", title: "", subjectYear: "", isRenewal: false, partyRep: p.partyRep, contractDate: "", level: p.level, coop: p.coop, custId: p.custId, period: { from: "", to: "" }, renewable: true, value: 0, valueKind: p.valueKind, graceDays: 45, payWithin: 14, status: "active", note: "", items: [], installments: [] };
  } else {
    cxEdit = { id: 0, kind: "base", parentId: null, code: "", title: "", subjectYear: "", isRenewal: false, partyRep: "", contractDate: "", level: "coop", coop: "", custId: "", period: { from: "", to: "" }, renewable: true, value: 0, valueKind: "rent", graceDays: 45, payWithin: 14, status: "active", note: "", items: [], installments: [] };
  }
  cxRenderEditor();
}
function cxRenderEditor() {
  ...
  const vkOpt = (k) => `<option value="${k}" ${c.valueKind === k ? "selected" : ""}>${t("cxvk_" + k)}</option>`;
  document.getElementById("rv").innerHTML = `<div class="panel"><header><h3>${isAdd ? t("cxIsAddendum") : (c.id ? t("cxBase") : t("cxNew"))}</h3>
  ...
  <div style="padding:12px 16px">
    ...
    <div class="grid g3">
      <div class="field"><label>${t("cxLevel")}</label><select id="cxLevel" onchange="cxLevelToggle()"><option value="coop" ${c.level === "coop" ? "selected" : ""}>${t("cxLevelCoop")}</option><option value="outlet" ${c.level === "outlet" ? "selected" : ""}>${t("cxLevelOutlet")}</option></select></div>
    ...
    <div class="grid g3" style="align-items:end">
      <div class="field"><label>${t("cxSplitCount")}</label><input id="cxSplitN" type="number" min="1" value="2"></div>
      <div class="actions"><button class="btn ghost sm" onclick="cxAutoSplit()">↔ ${t("cxAutoSplit")}</button></div>
    </div>
    <div class="tbl-wrap"><table><thead><tr><th>${t("cxSeq")}</th><th>${t("cxDue")}</th><th>${t("cxAmount")}</th><th>${t("cxStatus")}</th><th></th></tr></thead><tbody id="cxInstBody"></tbody></table></div>
...
function cxCoopChanged() {
  ...
  if (box) box.innerHTML = `<select id="cxCust">${cxOutletOptions(cxEdit.coop, "")}</select>`;
  cxRenderItems(); // refresh per-item outlet pickers
}
function cxScopeSelect(it, i) {
  const opt = (k) => `<option value="${k}" ${it.scope === k ? "selected" : ""}>${t("cxsc_" + k)}</option>`;
  return `<select class="cxItScope" onchange="cxScopeToggle(this,${i})">${opt("main")}${opt("branches")}${opt("outlet")}${opt("all")}</select>` +
    `<div class="cxItOutlet" style="margin-top:4px;${it.scope === "outlet" ? "" : "display:none"}"><select class="cxItCust">${cxOutletOptions(cxEditCoop(), it.custId)}</select></div>`;
}
...
function cxScopeToggle(sel, i) {
  const tr = sel.closest("tr");
  tr.querySelector(".cxItOutlet").style.display = sel.value === "outlet" ? "" : "none";
}
function cxSyncItems() {
  cxEdit.items = [...document.querySelectorAll("#cxItemsBody tr")].map((tr) => {
    const sp = tr.querySelector(".cxItSpace");
    const cust = tr.querySelector(".cxItCust");
    return {
      scope: tr.querySelector(".cxItScope").value,
...
function cxAutoSplit() {
  ...
  const total = parseFloat(document.getElementById("cxValue").value) || 0;
...
async function cxDoGenDN(id) {
  const c = cxData.contracts.find((x) => x.id === id); if (!c) return;
  const from = document.getElementById("dnFrom").value, to = document.getElementById("dnTo").value;
  const value = parseFloat(document.getElementById("dnAmt").value) || 0;
  const body = {
    type: "rentdebit",
  ...
  try {
    ...
    if (L && typeof openDoc === "function") openDoc(L, true);
  } catch (e) { toast(e.message); }
}

/* ---- contract fixture / space types ---- */
